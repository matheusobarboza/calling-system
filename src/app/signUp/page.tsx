  ...
  return (
    <main className="flex flex-col flex-1 items-center justify-center w-full px-20 text-center">
      <div className="bg-white rounded-2xl shadow-2xl flex w-2/3 items-center max-w-4xl">
        <form onSubmit={signUp} className="w-3/5 p-5 items-center">
          <div className="py-10">
          ...
          <button type="submit" className="border-2 border-green-500 text-green-500 rounded-full px-12 py-2 inline-block font-semibold hover:bg-green-500 hover:text-white transition-colors">Cadastrar</button>
        </form>
